...
if st.session_state['ans'] == 'ผู้ป่วยมีความเสี่ยงน้อยที่จะเสียเลือด ควรจองเลือดไม่เกิน 1 U ' and  st.session_state['quiz'] == 'คุณตอบว่าผู้ป่วยมีความเสี่ยงน้อยที่จะเสียเลือด'   :
    
    st.write("ยินดีด้วย คุณตอบถูก รับรางวัลไปเลย!")
